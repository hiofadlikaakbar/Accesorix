    ...
    <div class="max-w-2xl mx-auto px-6 py-10">
      ...
      <div class="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <h1 class="font-display text-2xl text-ink">Edit Produk</h1>
        </div>
      </div>
          ...
          <div class="space-y-2">
            ...
            >
              ...
              >
                ...
                >
                  <i
                    class="fa-solid fa-cloud-arrow-up text-xl text-ink-300"
                  ></i>
                </div>
                <div class="text-center">
                  <p class="font-body text-sm font-medium text-ink">
                    Klik atau drag & drop foto baru
                  </p>
...
async function fetchProduct() {
  ...
  if (data) {
    ...
    if (data.image_url) {
      ...
      // Simpan path lama untuk dihapus kalau ganti gambar
      oldImagePath.value = data.image_url.split("/products/")[1];
    }
  }
...
async function handleSubmit() {
  ...
  try {
    let image_url = imagePreview.value;

    // Kalau ada gambar baru di-upload
    if (imageFile.value) {
      // Hapus gambar lama dari storage
      if (oldImagePath.value) {
        await supabase.storage.from("products").remove([oldImagePath.value]);
      }
